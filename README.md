...
I designed something similiar for work as the first iteration. The method work was using before I made this was: A user types in a name and the page would submit a form and do a SQL query on the database to then get and display the results.
To me this felt clunky and not quick or clean, and didn't feel very good. So when I was tasked with making an admin page for a client where they can sort through users, I decided to try my hand at making something that felt more modern.
